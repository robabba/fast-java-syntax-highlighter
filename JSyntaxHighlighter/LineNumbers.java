...
public class LineNumbers extends StyledEditorKit{
	private static final long serialVersionUID = 3484452888385214674L;

	public ViewFactory getViewFactory(){
		return new LineNumberView();
	}
}

class LineNumberView implements ViewFactory{
